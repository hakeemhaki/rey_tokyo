...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			...
			'type' => 'text',
			'instructions' => 'Replace default with custom text for this product.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
...
<p>Adjust your website\'s typography settings. To customize frontend\'s typography, head over to Customizer > General > Typography.</p>',
		...
		array(
			...
			'label' => 'Singular Settings - User Roles',
			'name' => 'singular_settings_support_roles',
			'type' => 'select',
			'instructions' => 'Select allowed user roles to display the Singular settings.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
