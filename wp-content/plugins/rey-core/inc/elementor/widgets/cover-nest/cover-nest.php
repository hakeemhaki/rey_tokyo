...
if(!class_exists('ReyCore_Widget_Cover_Nest')):
	...
	class ReyCore_Widget_Cover_Nest extends \Elementor\Widget_Base {
		...
		public function rey_get_script_depends() {
			return [ 'animejs', 'rey-splide', 'imagesloaded', 'reycore-widget-cover-nest-scripts' ];
		}
				...
				<div class="splide__track">
					<div class="cNest-slider splide__list">
						...
						if( !empty($this->_items) ):
							...
							<div class="splide__slide cNest-slide elementor-repeater-item-<?php echo $item['_id'] ?> <?php echo ($key === 0 ? '--slide-active':'') ?>">
								<?php
