...
if( !class_exists('ReyCore_Widget_Menu__Product_Tags') ):

	class ReyCore_Widget_Menu__Product_Tags extends \Elementor\Skin_Base
	{
		...
		public function render_menu()
		{
			if( $this->_settings['pt_type'] === 'list' && ($tags = $this->_settings['pt_product_tags']) ){
				...
				$this->_terms = reyCoreHelper()->get_terms([
					'include' => $tags,
					'taxonomy' => self::TAX_NAME
				]);
