		...
		public function widget($args, $instance) {
			...
			if ($is_slider) {
				...
				$html .= '<div class="reyajfilter-price-filter-wrapper">';
					$html .= '<div id="reyajfilter-noui-slider" class="noUi-extended" data-min="' . $this->validate_number($min_price) . '" data-max="' . $this->validate_number($max_price) . '" data-set-min="' . $this->validate_number($current_min_price) . '" data-set-max="' . $this->validate_number($current_max_price) . '" data-before="'. $before .'" data-after="'. $after .'"></div>';
					$html .= '<br />';
