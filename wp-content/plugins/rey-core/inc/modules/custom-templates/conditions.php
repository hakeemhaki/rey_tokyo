...
if( !class_exists('ReyCore_Module_ReyTemplates_Conditions') ):

	class ReyCore_Module_ReyTemplates_Conditions
	{
							...
							switch ($location):
								...
								case 'categories':
									...
									if( isset($prod_archive_condition['categories']) ){
										...
										$conditions[ $operator ][ 'categories' ] = is_product_category($prod_categories);
									}
								...
								case 'tags':
									...
									if( isset($prod_archive_condition['tags']) ){
										$tags = $prod_archive_condition['tags'] ? $prod_archive_condition['tags'] : [];
										$conditions[ $operator ][ 'tags' ] = is_product_tag($tags);
									}
		 ...
		 * @return ReyCore_Module_ReyTemplates_Conditions
		 */
	...
	ReyCore_Module_ReyTemplates_Conditions::getInstance();
