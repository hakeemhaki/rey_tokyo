...
if( class_exists('WooCommerce') && !class_exists('ReyCore_Widget_Woo_Pdp_Buy_Now')):

class ReyCore_Widget_Woo_Pdp_Buy_Now extends ReyCore_Widget_Woo_Base {
	...
	function render_template() {
		...
		if( ! class_exists('ReyCore_Wc_BuyNowButton') ){
			return;
		}
		...
		ReyCore_Wc_BuyNowButton::getInstance()->display();
