...
if( class_exists('WooCommerce') && !class_exists('ReyCore_Widget_Woo_Pdp_Compare')):

class ReyCore_Widget_Woo_Pdp_Compare extends ReyCore_Widget_Woo_Base {
	...
	function render_template() {
		...
		ReyCore_WooCommerce_CompareRey::getInstance()->output_pdp_button();
