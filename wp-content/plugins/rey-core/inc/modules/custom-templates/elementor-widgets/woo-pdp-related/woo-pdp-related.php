...
if( class_exists('WooCommerce') && !class_exists('ReyCore_Widget_Woo_Pdp_Related')):

class ReyCore_Widget_Woo_Pdp_Related extends ReyCore_Widget_Woo_Base {
	...
	function render_template() {
		...
		add_filter('woocommerce_output_related_products_args', [$this, 'make_args']);
		...
		remove_filter('woocommerce_output_related_products_args', [$this, 'make_args']);
