...
if( class_exists('WooCommerce') && !class_exists('ReyCore_Widget_Woo_Pdp_Request_Quote')):

class ReyCore_Widget_Woo_Pdp_Request_Quote extends ReyCore_Widget_Woo_Base {
	...
	function render_template() {
		...
		ReyCore_WooCommerce_RequestQuote::getInstance()->get_button_html($args);
