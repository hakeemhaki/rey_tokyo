...
if( class_exists('WooCommerce') && !class_exists('ReyCore_Widget_Woo_Pdp_Wishlist')):

class ReyCore_Widget_Woo_Pdp_Wishlist extends ReyCore_Widget_Woo_Base {
	...
	function render_template() {
		...
		if( ! class_exists('ReyCore_WooCommerce_WishlistRey') ){
			return;
		}
		...
		ReyCore_WooCommerce_WishlistRey::getInstance()->output_pdp_button();
